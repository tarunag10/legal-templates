...
const { initTheme: initTheme } = __m1__Users_tarunagarwal_Documents_1_App_Developement_Tarun_Open_Access_UK_legal_templates_src_theme_js;
...
const { COLLECTIONS_KEY: COLLECTIONS_KEY, addToCollection: addToCollection, removeFromCollection: removeFromCollection, serializeCollections: serializeCollections, parseCollections: parseCollections } = __m3__Users_tarunagarwal_Documents_1_App_Developement_Tarun_Open_Access_UK_shared_collections_index_mjs;

const { currentGuidance: currentGuidance, templateCatalogue: templateCatalogue, getTemplate: getTemplate, renderTemplate: renderTemplate, filterTemplates: filterTemplates, getTemplateCategories: getTemplateCategories, buildTemplateExportMetadata: buildTemplateExportMetadata, normalizeFavouriteTemplates: normalizeFavouriteTemplates, sortTemplatesWithFavourites: sortTemplatesWithFavourites, buildMarkdownExport: buildMarkdownExport, buildTemplateBundle: buildTemplateBundle, buildTemplateBundleMetadata: buildTemplateBundleMetadata, buildTemplateCasePack: buildTemplateCasePack, buildTemplateLocalActionPack: buildTemplateLocalActionPack } = __m4__Users_tarunagarwal_Documents_1_App_Developement_Tarun_Open_Access_UK_legal_templates_src_templates_js;
